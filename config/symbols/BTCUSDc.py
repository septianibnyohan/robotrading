...
# 2 - 7
LOW_RISK_OVERRIDES = {
    "LOT_SIZE": 0.01 * (25), # sunday (1), 3, other max(12)
    "LAYERING_STEP_ATR_MULT": 1.0 * 1,
    "TAKE_PROFIT_PER_LAYER_USD": 0.20 * (25), #1
}
...
MODERATE_RISK_OVERRIDES = {
    "LOT_SIZE": 0.01 * (45), # Asian Session Window (07:00 - 15:00 WIB): Max layers reached was 24
    "LAYERING_STEP_ATR_MULT": 1.0 * 1,
    "TAKE_PROFIT_PER_LAYER_USD": 0.20 * (45), #25 - 100
}
