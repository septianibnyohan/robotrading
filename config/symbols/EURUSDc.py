SYMBOL = "EURUSDc"
MAGIC_NUMBER = 20260804
MAGIC_NUMBER_M5 = 20260805
MAGIC_NUMBER_M15 = 20260806


# Late-Night Window (22:00 - 01:00 WIB): Max layers encountered: 16.
# min 56, max = 220
LOT_SIZE = 0.01 * (100)
MAX_SPREAD_USD = 0.00030
SPREAD_DEDUCTION_USD = 0.00007
...
LAYERING_STEP_USD = 0.0020
TAKE_PROFIT_PER_LAYER_USD = 0.005 * (100)
...
LOW_RISK_OVERRIDES = {
    ...
    "TAKE_PROFIT_PER_LAYER_USD": 0.005 * (12), #1
}
...
MODERATE_RISK_OVERRIDES = {
    ...
    "LAYERING_STEP_ATR_MULT": 1.0 * 1,
    "TAKE_PROFIT_PER_LAYER_USD": 0.005 * (40), #25 - 100
}
